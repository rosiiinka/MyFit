    ...
    _createClass(App, [{
        ...
        value: function LOGIN_DEFAULT_USER() {
            ...
            $.ajax(request).done(function (userId) {
                ...
                console.log('User menu error', err);
                _this2.setState({
                    loggedInUserId: '',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Navbar.Navbar, { history: this.props.history, userData: userData }),
                this.props.children,
    ...
    _createClass(Home, [{
        ...
        value: function render() {
            var movies = this.state.topTenMovies.map(function (movie, index) {
                return _react2.default.createElement(_MovieCard.MovieCard, { key: movie._id, movie: movie, index: index });
            });
...
var MovieAdd = exports.MovieAdd = function (_React$Component) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('div', { className: 'tri invent' }),
                            _react2.default.createElement('div', { className: 'tri invent' }),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_NavbarUserMenu.NavbarUserMenu, { userData: this.props.userData })
                )
            );
        }
    }]);
...
exports.NavbarUserMenu = undefined;
...
var NavbarUserMenu = exports.NavbarUserMenu = function (_Component) {
...
exports.default = _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouter.Route, { path: '/movie/add', component: _MovieAdd.MovieAdd }),
    _react2.default.createElement(_reactRouter.Route, { path: '/user/profile/:userId', component: _UserProfile.UserProfile })
);

},{"./components/App":20,"./components/Home":22,"./components/MovieAdd":23,"./components/Navbar":24,"./components/UserProfile":25,"react":"react","react-router":"react-router"}],30:[function(require,module,exports){
"use strict";
